...
def extract_most_similar(cache_dir, extract_type, ref_keywords, all_terms, window_size, score_type, k):
...
class Command(AbstractCommand):
    ...
    def run(self, extract_type, window_size, k, score_type, recalculate_embedding):
        ...
        if extract_type == 'cv':
            ...
            extract_most_similar(self.cache_dir, extract_type, ref_keywords, all_terms, window_size, score_type, k)
...
if __name__ == '__main__':
    ...
    command = Command()
    start = time.time()
    command.run(extract_type=args.extract_type, window_size=args.window_size, k=args.k, score_type=args.score_type,
